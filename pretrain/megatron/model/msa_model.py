...
class MSAModelBase(MegatronModule):
    """MSA Language model."""

    def __init__(self, num_tokentypes=2, add_binary_head=True,
                 parallel_output=True):
        super(MSAModelBase, self).__init__()
        print_rank_0("Initiating MSA model base...")
        args = get_args()
...
class MSAModelFirstStage(MSAModelBase):
...
class MSAModelIntermediateStage(MSAModelBase):
...
class MSAModelLastStage(MSAModelBase):
