...
class TokenClassificationBase(MegatronModule):
    ...
    def __init__(self, num_classes, num_tokentypes=2):
        super(TokenClassificationBase, self).__init__(share_word_embeddings=False)
        args = get_args()
...
class TokenClassificationFirstStage(TokenClassificationBase):

    def __init__(self, num_classes, num_tokentypes=2):
        super(TokenClassificationFirstStage, self).__init__(
            num_classes, num_tokentypes=num_tokentypes)

    def forward(self, input_ids, attention_mask,
                tokentype_ids=None):
        return super(TokenClassificationFirstStage, self).forward(
            input_ids,
            attention_mask,
            tokentype_ids=tokentype_ids)


class TokenClassificationIntermediateStage(TokenClassificationBase):

    def __init__(self, num_classes, num_tokentypes=2):
        super(TokenClassificationIntermediateStage, self).__init__(
            num_classes, num_tokentypes=num_tokentypes)

    def forward(self, hidden_state, attention_mask):
        return super(TokenClassificationIntermediateStage, self).forward(
            hidden_state,
            attention_mask)


class TokenClassificationLastStage(TokenClassificationBase):

    def __init__(self, num_classes, num_tokentypes=2):
        super(TokenClassificationLastStage, self).__init__(
            num_classes, num_tokentypes=num_tokentypes)

    def forward(self, hidden_state, attention_mask):
        return super(TokenClassificationLastStage, self).forward(
            hidden_state,
            attention_mask)
